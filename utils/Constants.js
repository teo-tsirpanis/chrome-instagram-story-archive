...
export const INSTAGRAM_USER_IMAGE_CLASS_NAME = "_8gpiy _r43r5";
...
export const POPUP_CONTAINER_WIDTH = 750;
...
export const muiTheme = getMuiTheme({
  palette: {
    primary1Color: TAB_BACKGROUND_COLOR_WHITE,
    accent1Color: TAB_TEXT_COLOR_DARK_GRAY
  },
});